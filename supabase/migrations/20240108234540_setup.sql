...
AS $$
DECLARE
  project_url TEXT := 'https://pqiuugytwicergpxpflt.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBxaXV1Z3l0d2ljZXJncHhwZmx0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mjk4MzU0NTgsImV4cCI6MjA0NTQxMTQ1OH0.2-SS1BGe6i1x8jYWK9FUVbdnY8mycip_WHPeAPSPr-g'; -- full access needed for http request to storage
